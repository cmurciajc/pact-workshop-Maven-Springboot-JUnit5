...
public class PactVerificationTest {
  ...
  void productsExists() {
    ...
    productRepository.saveAll(Arrays.asList(
      new Product(100L, "Test Product 1", "CREDIT_CARD", "v1", "CC_001","STANDARD"),
      new Product(200L, "Test Product 2", "CREDIT_CARD", "v1", "CC_002","STANDARD"),
      new Product(300L, "Test Product 3", "PERSONAL_LOAN", "v1", "PL_001","STANDARD"),
      new Product(400L, "Test Product 4", "SAVINGS", "v1", "SA_001","STANDARD")
    ));
  }
  ...
  void productExists(Map<String, Object> params) {
    ...
    if (!product.isPresent()) {
      productRepository.save(new Product(productId, "Product", "TYPE", "v1", "001","STANDARD"));
    }
  }
